...
Видим что тот же объем данных загружен гораздо быстрее, впрочем, сравнение не совсем корректное. В клике мы грузим упакованные файлы, на лету их распаковывая. Постгри же загружает харанее распакованный файл и все упирается в медленный ввод-вывод огромных файлов
...
Ообъём данных, системные условия были практически идентичными.
