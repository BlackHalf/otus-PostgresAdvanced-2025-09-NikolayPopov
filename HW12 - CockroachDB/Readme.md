...
Импорт выполняется относительно быстро, работать с кластером удобно. Понравилось, что распределение запросов по нодам делается полностью автоматически, как и репликация данных.