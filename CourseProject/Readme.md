...
1.
Ставим pg_probackup, настраиваем
```
...
Бэкап можно делать как с ведущей, так и с ведомой ноды.
```
...
Восстановление как обычно делается через инициализацию нового кластера из бэкапа
